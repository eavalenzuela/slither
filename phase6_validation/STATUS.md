...
| V10 | ⏳ operator (TPM instance up at slither-tpm) | OPERATOR_WALKTHROUGH.md |
...
bbf02618cc75 + earlier). The 4 follow-ups above are real bugs
surfaced by validation, not code regressions. Phase 6 closes
when:
  (a) operator captures V2 + V5 + V6 + V7 + V8 + V10 land under
      phase6_validation/
  (b) docs/phase6-validation.md status flips to "completed"
  (c) the 4 follow-ups are filed as Phase 7 task entries in
      IMPLEMENTATION.md §9 (TPM follow-ups already there;
      append #1-#4 above)

...
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang -target bpfel -type dns_event -go-package bpf -output-dir . -output-stem dns Dns src/dns.bpf.c -- -I./src/headers -Wall -O2 -g
